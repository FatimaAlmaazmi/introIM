...
void draw() {
  ...
  //state = 0 displays the start screen
  if (state == 0) {
  ...
  // if the mouse presses start, state = 1 which displays the game
  ...
  //state = 2 displpays the losing screen
  if (state == 2) {
  ...
  // state = 3 displays the winning screen
  if (state == 3) {
